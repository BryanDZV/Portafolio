  ...
  return (
    ...
    >
      ...
      <m.div
        ...
        className="absolute top-0 left-0 -ml-[175px] -mt-[175px] w-[350px] h-[350px] bg-[radial-gradient(circle,rgba(120,0,255,0.35)_30%,rgba(34,211,238,0.15)_30%,transparent_50%)] mix-blend-plus-lighter blur-2xl"
      />
      ...
      {trail4 && (
        <m.div
          style={trail4}
          animate={{ scale: isHovering ? 1.2 : 4 }}
      ...
      <m.div
        style={trail3}
        animate={{ scale: isHovering ? 1.4 : 2 }}
